...
// PLAN 7 TASK 9 TRANSITIONAL MCP BOUNDARY — Task 11 must remove this file.
// Only lib/mcp/** may import this helper. Product/web callers must use food-handoff.ts current-generation authority.
...
export type TransitionalMcpFoodHandoffInput = {
  foodId: string;
...
export async function resolveTransitionalMcpFoodHandoff(
  supabase: SupabaseClient,
  userId: string,
  input: TransitionalMcpFoodHandoffInput,
