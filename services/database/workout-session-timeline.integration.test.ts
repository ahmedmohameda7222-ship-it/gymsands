...
const verificationFiles = [
  "supabase/verification/active-workout-aw2c-timeline-events.sql",
  "supabase/verification/active-workout-aw2c-integration.sql"
] as const;
...
describe.skipIf(!databaseUrl)("AW-2C permanent PostgreSQL verification assets", () => {
  it("executes the durable schema, RLS, ACL, constraint, index, and marker contract", () => {
    expect(() => runVerification(verificationFiles[0])).not.toThrow();
  }, 120_000);

  it("executes start, commands, sets, completion, cancellation, delete bridge, skip, and isolation semantics in rollback", () => {
