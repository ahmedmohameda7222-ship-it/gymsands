...
// ChatGPT/OpenAI-specific action icon only. Do not use as Plaivra branding.
export const ChatGptMark = forwardRef<ChatGptMarkHandle, ChatGptMarkProps>(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    const stop = () => {
      animate(".internal", { pathOffset: 0 }, { duration: 0.3, ease: "easeInOut" });
    };
...
ChatGptMark.displayName = "ChatGptMark";
