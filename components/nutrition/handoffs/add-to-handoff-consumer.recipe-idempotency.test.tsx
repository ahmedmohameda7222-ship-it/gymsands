...
const mocks = vi.hoisted(() => ({
  ...
  refresh: vi.fn(),
  searchParams: {
    toString: () => "destination=recipe&ingredientFoodId=55555555-5555-4555-8555-555555555555&source=catalog&quantity=2&serving=100%20g&displayName=Atomic%20chicken&languageTag=en",
  },
}));
