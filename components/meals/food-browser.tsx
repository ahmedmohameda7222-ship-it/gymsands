...
function confidenceForLog(log: FoodLog) { const notes = (log.notes || "").toLowerCase(); if (notes.includes("quick/manual") || notes.includes("estimated")) return "estimated"; if (log.user_food_item_id) return "user-created"; if (log.food_item_id) return "library"; if (notes.includes("import")) return "imported"; return "estimated"; }
