    ...
    <div className="min-h-screen">
      ...
      <main className="container py-12">
        <section className="max-w-4xl">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-normal text-slate-950">The Paradigm Shift in Fitness</h1>
          <div className="mt-6 space-y-8 text-base leading-8 text-slate-600">
            <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold tracking-normal text-slate-950">The Problem: Trapped in the Chat</h2>
              <p className="mt-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold tracking-normal text-slate-950">Our Solution: The Execution Layer</h2>
              <p className="mt-3">
              ...
              <div className="mt-5 space-y-4">
                <p>
                  <span className="font-semibold text-slate-950">Interactive Workout Splits:</span> Text descriptions
                  instantly become chronological calendars, target sets, exact rep goals, and automated rest timers.
                </p>
                <p>
                  <span className="font-semibold text-slate-950">Fluid Meal Parsing:</span> Casual recipe descriptions are
                  translated into strict macronutrient targets, protein metrics, and clean grocery lists.
                </p>
                <p>
                  <span className="font-semibold text-slate-950">Smart Name Bridge:</span> Mismatched names or unique
            ...
            <section>
              <h2 className="text-2xl font-semibold tracking-normal text-slate-950">Our Philosophy</h2>
              <p className="mt-3">
