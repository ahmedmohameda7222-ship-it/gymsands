...
const detail: LibraryActivityDetail = {
  ...
  executionProfiles: [],
  bodyEffects: [],
  prescriptionSchema: { id: "33333333-3333-4333-8333-333333333333", key: "strength_repetition", version: 1, fields: [], checksum: "c".repeat(64) },
  performedMetricSchema: { id: "44444444-4444-4444-8444-444444444444", key: "strength_repetition", version: 1, fields: [], contextDimensions: [], checksum: "d".repeat(64) },
...
describe("P10F Catalog authority materialization", () => {
  it("freezes release, revision, schema, records, mapping, policy, and capability authority", () => {
    ...
    expect(snapshot).toMatchObject({
      ...
      revisionNumber: 3,
      prescriptionSchema: { id: detail.prescriptionSchema!.id, key: "strength_repetition", version: 1, checksum: "c".repeat(64) },
      performedMetricSchema: { id: detail.performedMetricSchema!.id, key: "strength_repetition", version: 1, checksum: "d".repeat(64) },
