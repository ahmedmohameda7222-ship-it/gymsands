...
export function configuredProviders() {
  return [
    ...
    { provider: "USDA", configured: Boolean(serverEnv.usdaApiKey) },
    { provider: "Edamam", configured: Boolean(serverEnv.edamamAppId && serverEnv.edamamAppKey) },
    { provider: "Nutritionix", configured: Boolean(serverEnv.nutritionixAppId && serverEnv.nutritionixApiKey) },
    { provider: "wger", configured: Boolean(serverEnv.wgerApiKey) },
    { provider: "OpenAI", configured: Boolean(serverEnv.openaiApiKey) },
