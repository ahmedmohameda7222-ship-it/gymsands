...
export const mcpTools: McpToolDefinition[] = [
  ...
  { name: "generate_shopping_list", title: "Build shopping list", description: "Build an aggregated shopping list from saved FitLife meal-plan items for a date range. This does not create or guess meals.", inputSchema: objectSchema({ start_date: isoDate, end_date: isoDate }, ["start_date", "end_date"]), risk: "read" },
