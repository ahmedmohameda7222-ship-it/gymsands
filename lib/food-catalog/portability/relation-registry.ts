...
export const FOOD_CATALOG_PORTABLE_RELATIONS_V1: readonly PortableRelationRule[] = Object.freeze([
  ...
  rule("food_market_relevance", C, "RESTORE_EXACT", ["food_id", "country_code"]),
  rule("food_taxonomy_namespaces", A, "VALIDATE_PRESEEDED", ["namespace_key"], { seedOwnership: "MIGRATION_OWNED" }),
  rule("food_taxonomy_nodes", A, "VALIDATE_PRESEEDED", ["id"], { seedOwnership: "MIGRATION_OWNED" }),
  rule("food_taxonomy_assignments", A, "RESTORE_EXACT", ["id"]),
  rule("market_scopes", A, "VALIDATE_PRESEEDED", ["id"], { seedOwnership: "MIGRATION_OWNED" }),
  rule("market_scope_memberships", A, "VALIDATE_PRESEEDED", ["parent_scope_id", "child_scope_id"], { seedOwnership: "MIGRATION_OWNED" }),
  ...
  rule("food_catalog_activation_set_members", A, "RESTORE_EXACT", ["activation_set_id", "food_id"]),
  ...
  rule("food_catalog_generation_names", A, "RESTORE_EXACT", ["generation_id", "food_id", "name_id"]),
  ...
  rule("food_catalog_search_documents", "DERIVED_REBUILD", "DERIVED_REBUILD", ["generation_id", "food_id"], {
  ...
  rule("food_catalog_lifecycle_events", PH, "RESTORE_EXACT", ["id"], { requiredProfile: "FULL_DR", protected: true }),
  ...
  rule("food_catalog_serving_fact_lineages", PA, "RESTORE_EXACT", ["id"], { requiredProfile: "FULL_DR", protected: true }),
  rule("food_catalog_serving_fact_revisions", PA, "RESTORE_EXACT", ["lineage_id", "serving_option_id"], { requiredProfile: "FULL_DR", protected: true }),
  rule("food_catalog_name_fact_lineages", PA, "RESTORE_EXACT", ["id"], { requiredProfile: "FULL_DR", protected: true }),
  rule("food_catalog_name_fact_revisions", PA, "RESTORE_EXACT", ["lineage_id", "name_fact_id"], { requiredProfile: "FULL_DR", protected: true }),
