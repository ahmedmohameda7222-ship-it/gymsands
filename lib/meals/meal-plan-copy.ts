...
const en = {
  ...
  day: "Day", week: "Week", shopping: "Shopping", previousDay: "Previous day", nextDay: "Next day", today: "Today", selected: "Selected",
  ...
  dailyOverview: "Daily overview", effectiveTarget: "Effective target", scheduled: "Scheduled", consumed: "Consumed", remaining: "Remaining", overTarget: "Over target",
  ...
  previousWeek: "Previous week", nextWeek: "Next week", weekRange: "{start} – {end}", noWeekMeals: "No meals", target: "Target", activeCalories: "Active scheduled", consumedCalories: "Consumed",
...
const de: typeof en = {
  ...
  day: "Tag", week: "Woche", shopping: "Einkauf", previousDay: "Vorheriger Tag", nextDay: "Nächster Tag", today: "Heute", selected: "Ausgewählt", loadingMeals: "Mahlzeiten werden geladen…", loadMealsError: "Mahlzeiten konnten nicht geladen werden.", retry: "Erneut versuchen", targetUnavailable: "Das Ernährungsziel ist vorübergehend nicht verfügbar.",
  dailyOverview: "Tagesübersicht", effectiveTarget: "Aktives Ziel", scheduled: "Eingeplant", consumed: "Verzehrt", remaining: "Verbleibend", overTarget: "Über dem Ziel", protein: "Protein", carbs: "Kohlenhydrate", fat: "Fett", planned: "Geplant", done: "Erledigt", skipped: "Übersprungen", alignment: "Plan-Ziel-Abgleich",
...
const ar: typeof en = {
  ...
  day: "اليوم", week: "الأسبوع", shopping: "التسوّق", previousDay: "اليوم السابق", nextDay: "اليوم التالي", today: "اليوم", selected: "محدد", loadingMeals: "جارٍ تحميل الوجبات…", loadMealsError: "تعذّر تحميل الوجبات.", retry: "إعادة المحاولة", targetUnavailable: "هدف التغذية غير متاح مؤقتًا.",
  dailyOverview: "نظرة يومية", effectiveTarget: "الهدف الفعّال", scheduled: "المجدول", consumed: "المستهلك", remaining: "المتبقي", overTarget: "فوق الهدف", protein: "البروتين", carbs: "الكربوهيدرات", fat: "الدهون", planned: "مخطط", done: "مكتمل", skipped: "متخطّى", alignment: "توافق الخطة مع الهدف",
  ...
  deleteTitle: "حذف الوجبة؟", deleteDesc: "سيتم حذف الوجبة المخططة.", removeLoggedTitle: "إزالة الوجبة المكتملة من الخطة؟", removeLoggedDesc: "سيتم حذفها من الخطة، لكن السعرات المستهلكة ستظل محفوظة في سجل التغذية.", previousWeek: "الأسبوع السابق", nextWeek: "الأسبوع التالي", weekRange: "{start} – {end}", noWeekMeals: "لا توجد وجبات", target: "الهدف", activeCalories: "السعرات المجدولة", consumedCalories: "السعرات المستهلكة",
