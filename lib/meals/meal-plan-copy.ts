...
const en = {
  ...
  addBreakfast: "Add breakfast", addLunch: "Add lunch", addDinner: "Add dinner", addSnack: "Add snack",
  quantityServing: "{quantity} × {serving}", markDone: "Done", saving: "Saving…", adjust: "Adjust", skip: "Skip", edit: "Edit",
  ...
  directTitle: "Add directly", foodName: "Food name", mealType: "Meal type", quantity: "Quantity", serving: "Serving", nutritionDetails: "Nutrition details",
  ...
  groceryAdded: "Added to grocery list", groceryDuplicate: "Already in grocery list", mealRemoved: "Meal removed", actionError: "The action could not be completed.",
  ...
  replace: "Replace", cheaper: "Cheaper", faster: "Faster", moreProtein: "More protein", swapIngredient: "Swap ingredient", dairyFree: "Dairy-free", glutenFree: "Gluten-free", changeCuisine: "Change cuisine",
...
const de: typeof en = {
  ...
  addBreakfast: "Frühstück hinzufügen", addLunch: "Mittagessen hinzufügen", addDinner: "Abendessen hinzufügen", addSnack: "Snack hinzufügen", quantityServing: "{quantity} × {serving}", markDone: "Erledigt", saving: "Speichern…", adjust: "Anpassen", skip: "Überspringen", edit: "Bearbeiten", addGrocery: "Zur Einkaufsliste", remove: "Entfernen", removePlan: "Aus Plan entfernen", adjustChatGPT: "Mit ChatGPT anpassen",
  ...
  chatAdjustTitle: "Mahlzeit mit ChatGPT anpassen", chatAdjustDesc: "Wähle eine gezielte Anpassung. ChatGPT erhält nur autorisierten Essensplan-Kontext.", replace: "Ersetzen", cheaper: "Günstiger", faster: "Schneller", moreProtein: "Mehr Protein", swapIngredient: "Zutat tauschen", dairyFree: "Laktosefrei", glutenFree: "Glutenfrei", changeCuisine: "Küche ändern", close: "Schließen", statusPlanned: "Geplant", statusDone: "Erledigt", statusSkipped: "Übersprungen", repairCompletion: "Abschluss reparieren", invalidRow: "Dieser gespeicherte Eintrag ist inkonsistent und muss korrigiert werden.", meals: "Mahlzeiten", upToDate: "Aktuell"
};
...
const ar: typeof en = {
  ...
  addBreakfast: "إضافة إفطار", addLunch: "إضافة غداء", addDinner: "إضافة عشاء", addSnack: "إضافة وجبة خفيفة", quantityServing: "{quantity} × {serving}", markDone: "تم", saving: "جارٍ الحفظ…", adjust: "تعديل", skip: "تخطّي", edit: "تعديل", addGrocery: "إضافة للمشتريات", remove: "إزالة", removePlan: "إزالة من الخطة", adjustChatGPT: "تعديل باستخدام ChatGPT",
  ...
  directTitle: "إضافة مباشرة", foodName: "اسم الطعام", mealType: "نوع الوجبة", quantity: "الكمية", serving: "الحصة", nutritionDetails: "تفاصيل التغذية", calories: "السعرات", notes: "ملاحظات", save: "حفظ الوجبة", cancel: "إلغاء", required: "هذا الحقل مطلوب.", positive: "أدخل قيمة أكبر من صفر.", nonNegative: "أدخل صفرًا أو قيمة موجبة.",
  mealAdded: "تمت إضافة الوجبة", mealUpdated: "تم تحديث الوجبة", mealDone: "تم إكمال الوجبة", mealAlreadyDone: "كانت الوجبة مكتملة بالفعل ولم يتم إنشاء سجل مكرر.", mealSkipped: "تم تخطّي الوجبة", groceryAdded: "تمت الإضافة إلى قائمة المشتريات", groceryDuplicate: "موجودة بالفعل في قائمة المشتريات", mealRemoved: "تمت إزالة الوجبة", actionError: "تعذّر إكمال الإجراء.",
  ...
  chatAdjustTitle: "تعديل الوجبة باستخدام ChatGPT", chatAdjustDesc: "اختر تعديلًا محددًا. سيصل إلى ChatGPT فقط سياق خطة الوجبات المصرح به.", replace: "استبدال", cheaper: "أقل تكلفة", faster: "أسرع", moreProtein: "بروتين أكثر", swapIngredient: "تبديل مكوّن", dairyFree: "بدون ألبان", glutenFree: "بدون جلوتين", changeCuisine: "تغيير المطبخ", close: "إغلاق", statusPlanned: "مخطط", statusDone: "مكتمل", statusSkipped: "متخطّى", repairCompletion: "إصلاح الإكمال", invalidRow: "هذا السجل غير متّسق ويجب تصحيحه قبل استخدامه.", meals: "وجبات", upToDate: "محدّث"
};
