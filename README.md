...
- `20260803152000_private_app_bootstrap_v1.sql` is a repository-only PCS-2 migration pending explicit Production authorization. It has not been applied; the ledger therefore records `pendingCount = 1`, `unresolvedCount = 1`, and `historyRepair.state = pending`.
