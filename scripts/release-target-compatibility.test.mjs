...
test("release consumers preserve the declared marker after the applied Plan 5 serving correction is reconciled", () => {
  ...
  assert.equal(deriveReleaseReadyTarget(ledger).releaseReady, true);
