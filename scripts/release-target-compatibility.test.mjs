...
test("release consumers preserve the declared marker and expose reconciled Plan 3 physical authority", () => {
...
test("preflight validates the declared marker after Plan 3 ledger reconciliation", () => {
