...
test("release consumers preserve the declared marker and block release while Plan 6 is pending", () => {
...
test("preflight preserves the declared marker but blocks release while Plan 6 remains pending", () => {
