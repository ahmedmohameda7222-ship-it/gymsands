...
test("all release target consumers preserve the declared compatibility marker while the Plan 1 migration remains pending", () => {
  ...
  assert.throws(() => deriveReleaseReadyTarget(ledger), /migration ledger/i);
});

test("preflight preserves the declared marker and blocks release while the Plan 1 migration remains pending", () => {
