...
test("declared database marker remains distinct from the reconciled Plan 3 physical head", () => {
...
test("Next build metadata binds the declared compatibility marker and exposes reconciled Plan 3 ledger state", async () => {
