...
test("declared database marker remains distinct from newer compatible physical migrations", () => {
  ...
  assert.equal(resolved.latestAppliedMigrationVersion, "20260804180932");
  assert.ok(
...
test("Next build metadata binds the declared compatibility marker", async () => {
  ...
  assert.equal(releaseMetadata.latestAppliedMigrationVersion, "20260804180932");
