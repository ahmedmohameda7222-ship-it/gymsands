...
test("declared database marker remains distinct from the reconciled Plan 5 physical head while Plan 6 stays pending", () => {
...
test("Next build metadata preserves the declared marker and exposes pending Plan 6 reconciliation", async () => {
