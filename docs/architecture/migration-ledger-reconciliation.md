...
**Status:** Applied Production history reconciled; nine repository migrations intentionally pending
...
- Repository-only pending migrations: **9**
- `pendingCount = 9`
