...
- `20260924063000_food_catalog_owner_reconciliation_expand_authority.sql`: `pending` (repository-only Tasks 13–14 owner reconciliation/search/MCP expand authority; not applied to Production; no Production version/name)
- `pendingCount = 5`
