...
**Status:** Production migration history is reconciled through the Plan 6 GTIN-lock exactness correction; two repository-only Plan 7 migrations are pending and unapplied
