...
The machine-readable public catalog is [`public-tool-catalog.json`](public-tool-catalog.json). It is the repository catalog authority for the current allowlist, replacements, and retired tools.
