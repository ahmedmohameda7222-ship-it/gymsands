...
Current global status: **Dashboard, onboarding, workout plans, workout session, calories, meal plan, hydration, wellness, progress, settings, AI imports, data privacy, and preferences audited. Calories and meal plan were reframed after the AI-first product clarification. Hydration is a direct quick-logging exception. Wellness is a calm hub/check-in route. Progress is a sensitive direct-tracking route. Settings is a trust/control hub. AI imports is the permission/connection trust layer. Data privacy is the sensitive visibility/export/settings-reset route. Preferences is the app-behavior/accessibility route.**
...
| Preferences | Audited | 62 | Good coverage of app behavior, but needs inline save/load errors, pending/rollback state, 48px selects, mobile stacking, and reduced-motion-safe theme interactions. Full audit: `docs/ux-progress/routes/settings-preferences.md`. |
...
| 2026-07-06 | `/settings/preferences` | Completed preferences route audit | Score 62/100; needs settings-state hardening, 48px selects, and reduced-motion-safe interactions | `3236e76d673347b59f8f9638c6690b7a7f48cb31` |
...
13. `/settings/preferences` — audited, fixes open
14. `/my-workout/plans/[planId]/edit` or workout day editor route
15. Exercise library
16. Workout history
